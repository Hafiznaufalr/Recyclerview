package com.hafiznaufalr.net.recyclerview;
...
import com.hafiznaufalr.net.recyclerview.adapter.PsAdapter;
import com.hafiznaufalr.net.recyclerview.model.Petshop;

import java.util.ArrayList;

public class MainActivity extends AppCompatActivity implements PsAdapter.IHotelAdapter {
    ...
    ArrayList<Petshop> mList = new ArrayList<>();
    PsAdapter mAdapter;
    ArrayList<Petshop> mListAll = new ArrayList<>();
    boolean isFiltered;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new PsAdapter(this, mList);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_ADD && resultCode == RESULT_OK) {
            Petshop hotel = (Petshop) data.getSerializableExtra(HOTEL);
            mList.add(hotel);
    ...
    private void fillData() {
        ...
        for (int i = 0; i < arJudul.length; i++) {
            mList.add(new Petshop(arJudul[i], arDeskripsi[i], arDetail[i], arLokasi[i], arFoto[i]));
    ...
    public void doFav(int pos) {
        ...
        dialPhoneIntent.setData(Uri.parse("tel:" ));
